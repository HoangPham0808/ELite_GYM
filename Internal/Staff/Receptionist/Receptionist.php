            ...
            <header class="topbar">
                <div class="topbar-left">
                    <div class="page-icon-wrap" id="page-icon-wrap">
                        <i class="fas fa-receipt" id="page-icon"></i>
                    </div>
                    <div class="page-title-wrap">
                        <h1 class="page-title" id="page-title">QUẢN LÝ HOÁ ĐƠN</h1>
                        <span class="breadcrumb" id="breadcrumb">Trang chủ / Hoá đơn</span>
                    </div>
                </div>
