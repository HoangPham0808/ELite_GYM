        ...
        <div class="table-wrapper">
            <table>
                <colgroup>
                    ...
                    <col style="width:15%">  <!-- Nhân viên -->
                    <col style="width:14%">  <!-- Chức vụ -->
                    <col style="width:9%">   <!-- Giới tính -->
                    <col style="width:10%">  <!-- Ngày sinh -->
                    <col style="width:12%">  <!-- SĐT -->
                    <col style="width:16%">  <!-- Email -->
                    <col style="width:11%">  <!-- Lương -->
                    <col style="width:13%">   <!-- Thao tác -->
                </colgroup>
                <thead>
                    <tr>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    <label>Lương cơ bản (₫/tháng) <span class="required">*</span></label>
...
<div class="bulk-action-bar" id="bulkActionBar">
    <div class="bulk-info">
        <i class="fas fa-check-square" style="color:#d4a017"></i>
        Đã chọn <strong id="bulkSelectedCount">0</strong> nhân viên
    </div>
    <div class="bulk-actions">
        <button class="btn-secondary btn-sm" onclick="clearSelection()">
            <i class="fas fa-times"></i> Bỏ chọn
        </button>
        <button class="btn-danger btn-sm" onclick="confirmBulkDelete()">
...
<div class="modal-overlay" id="confirmBulkModal">
    <div class="modal confirm-modal">
        <div class="modal-body">
            <div class="confirm-icon"><i class="fas fa-trash-alt"></i></div>
            <h4>Xóa hàng loạt?</h4>
            <p>Bạn có chắc muốn xóa <strong id="bulkDeleteCount">0</strong> nhân viên đã chọn?<br>
            Nhân viên có dữ liệu liên quan (chấm công, lương, lớp học) sẽ bị bỏ qua.<br>
            <span style="color:#f87171">Hành động này không thể hoàn tác.</span></p>
        </div>
        <div class="modal-footer" style="justify-content:center">
            <button class="btn-secondary" onclick="closeBulkConfirmModal()">Hủy</button>
            <button class="btn-danger" onclick="doBulkDelete()"><i class="fas fa-trash"></i> Xóa</button>
        </div>
    </div>
</div>
