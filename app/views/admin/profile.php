...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('css/Profile_employee.css') ?>">
...
<div class="page-wrap">
    ...
    <main class="main-content">
        ...
        <div class="card card-payroll">
            <div class="card-header">
                <div class="card-header-icon" style="background:rgba(181,137,15,.1);border-color:rgba(181,137,15,.25);color:#b5890f">
                    <i class="fas fa-wallet"></i>
                </div>
                <h3 class="card-title">Bảng lương</h3>
                <span style="font-size:11px;color:var(--tm);background:var(--surface-2);border:1px solid var(--border-md);padding:3px 10px;border-radius:20px;">
                    6 tháng gần nhất
                </span>
            </div>
            <div id="payrollContent">
                <div style="padding:28px;text-align:center;color:var(--tm)">
