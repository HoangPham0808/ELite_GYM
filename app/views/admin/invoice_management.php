...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('css/Invoice_Management.css') ?>">
        ...
        <div class="table-wrapper">
            <table>
                ...
                <tbody id="invoiceTbody">
                    <tr>
                        <td colspan="11" class="loading-cell"><i class="fas fa-spinner fa-spin"></i></td>
                    </tr>
                </tbody>
            </table>
        </div>
...
<script>
    window.USER_ROLE  = '<?php echo htmlspecialchars($_SESSION['role'] ?? $_user_role ?? 'Employee', ENT_QUOTES); ?>';
    window.ELITE_BASE = '<?php echo rtrim(BASE_URL, '/'); ?>';
</script>
<script src="<?= asset('js/Invoice_Management.js') ?>"></script>
<div id="printInvoiceArea"></div>
</body>
</html>
