...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('css/Schedule_Management.css') ?>">
...
<body>
<div class="sch-container mod-schedule" data-module="schedule">
...
<script src="<?= asset('js/Schedule_Management.js') ?>"></script>
</body>
</html>
