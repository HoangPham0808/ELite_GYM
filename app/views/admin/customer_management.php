...
<head>
    ...
    <link rel="stylesheet" href="<?= asset('css/Customer_Management.css') ?>">
...
<script>
    <?php
        ...
        if (!preg_match('#^https?://#', $__base)) {
            $__scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
            $__host   = $_SERVER['HTTP_HOST'] ?? 'localhost';
            $__base   = $__scheme . '://' . $__host . '/' . ltrim($__base, '/');
        }
        $__base = rtrim($__base, '/');
    ?>
    window.ELITE_BASE = '<?php echo $__base; ?>';
</script>
<script src="<?= asset('js/Customer_Management.js') ?>"></script>
