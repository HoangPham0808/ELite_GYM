...
<body>
    <div class="app-shell">
        ...
        <aside class="sidebar">
            <div class="sidebar-logo-wrap">
                <div class="logo-hex">
                    <img src="<?= asset('images/ELITY.png') ?>" alt="Elite Gym Logo">
                </div>
                <div class="logo-text">
            ...
            <nav class="sidebar-nav">
                <div class="nav-group">
                    ...
                    <ul>
                        <li class="nav-item active" data-page="overview.php">
                ...
                <div class="nav-group">
                    ...
                    <ul>
                        ...
                        <li class="nav-item" data-page="review.php">
                            <a href="#review.php">
        ...
        <div class="main-wrap">
            <header class="topbar">
                <div class="topbar-left">
                    <div class="page-icon-wrap" id="page-icon-wrap" style="background:rgba(59,130,246,0.25)">
                        <i class="fas fa-th-large" id="page-icon" style="color:#60a5fa"></i>
                    </div>
                    <div class="page-title-wrap">
                        <h1 class="page-title" id="page-title">TỔNG QUAN</h1>
                        <span class="breadcrumb" id="breadcrumb">Trang chủ / Tổng quan</span>
                    </div>
                </div>
    ...
    <script src="<?= asset('js/legacy-ready.js') ?>?v=2"></script>
    <script src="<?= asset('js/adm.js') ?>?v=overview-default"></script>
</body>
</html>
