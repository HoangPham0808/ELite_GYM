...
<link rel="stylesheet" href="<?= asset('css/Review_Management.css') ?>"/>
</head>
<body>
...
<div class="rm-modal-backdrop" id="rmConfirmBd">
  <div class="rm-modal rm-modal-sm">
    <div class="rm-modal-header rm-modal-header-danger" id="rmConfirmHeader">
      <div class="rm-modal-title">
        <i id="rmConfirmIcon" class="fas fa-triangle-exclamation"></i>
        <span id="rmConfirmTitle">Xác nhận xóa</span>
      </div>
    </div>
    <div class="rm-modal-body">
      <p id="rmConfirmMsg" style="color:var(--ts);font-size:14px;line-height:1.6"></p>
    </div>
    <div class="rm-modal-footer">
...
<script src="<?= asset('js/Review_Management.js') ?>"></script>
</body>
</html>
