...
<body>
    ...
    <div class="forgot-container">
        <div class="forgot-box">
            ...
            <form id="forgotPasswordForm" method="POST" action="<?= url('forgot-password') ?>" class="forgot-form">
            ...
            <?php elseif ($step === 2): ?>
            <!-- ===== BƯỚC 2: Nhập OTP ===== -->
            <form id="otpForm" method="POST" action="<?= url('forgot-password') ?>" class="forgot-form">
            ...
            <form method="POST" action="<?= url('forgot-password') ?>" id="resendForm" style="display:none;">
                <input type="hidden" name="action" value="resend_otp">
            </form>

            <?php elseif ($step === 3): ?>
            <!-- ===== STEP 3: Set new password ===== -->
            <form id="resetPasswordForm" method="POST" action="<?= url('forgot-password') ?>" class="forgot-form">
