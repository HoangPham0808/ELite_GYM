...
<header class="nav" id="nav">
      ...
      <?php if ($is_customer): ?>
        ...
        <div class="nav-user-wrap" id="navUserWrap">
          ...
          <div class="nav-dropdown" id="navDropdown">
            <a href="<?= url('profile') ?>"><i class="fas fa-user-circle"></i> Hồ sơ của tôi</a>
            <a href="<?= url('profile') ?>?tab=checkin"><i class="fas fa-calendar-check"></i> Lịch sử check-in</a>
            <a href="<?= url('profile') ?>?tab=plans"><i class="fas fa-id-card"></i> Gói tập của tôi</a>
            <div style="border-top:1px solid rgba(255,255,255,.07);margin:4px 0"></div>
            <a href="<?= url('logout') ?>" class="nd-logout"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
          </div>
        </div>
      <?php else: ?>
        <a href="<?= url('login') ?>"       class="nav-login">Đăng nhập</a>
        <a href="<?= url('register') ?>" class="nav-cta"><i class="fas fa-bolt"></i>&nbsp;Tham gia ngay</a>
      <?php endif; ?>
    </div>
  ...
  <div class="mobile-menu" id="mobileMenu">
    <?php if ($is_customer): ?>
      <a href="#schedule">Gói tập</a>
      <a href="<?= url('schedule') ?>">Lịch tập</a>
      <a href="#checkin">Hướng dẫn</a>
      <a href="#reviews">Đánh giá</a>
      <a href="<?= url('profile') ?>" class="mm-cta"><i class="fas fa-user-circle"></i> Hồ sơ của tôi</a>
      <a href="<?= url('logout') ?>" class="mm-login" style="color:#f87171"><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
    <?php else: ?>
      <a href="#features">Tính năng</a>
      <a href="#plans">Gói tập</a>
      <a href="#gallery">Không gian</a>
      <a href="#how">Bắt đầu</a>
      <a href="#reviews">Đánh giá</a>
      <a href="<?= url('login') ?>"       class="mm-login">Đăng nhập</a>
      <a href="<?= url('register') ?>" class="mm-cta">Tham gia ngay</a>
    <?php endif; ?>
  </div>
</header>
  ...
  <div class="wrap">
    <div class="hero-left">
      ...
      <div class="hero-btns-cus">
        <a href="<?= url('profile') ?>" class="btn-gold"><i class="fas fa-user-circle"></i> Xem hồ sơ</a>
...
<section class="shop-section" id="plans">
  ...
  <div style="text-align:center;margin-top:28px;color:#888;font-size:13px;padding:0 40px">
    ...
    <a href="<?= url('login') ?>" style="color:var(--red);font-weight:600">Đăng nhập</a> để đăng ký gói tập ngay hôm nay!
  </div>
  <?php endif; ?>
</section>
<?php endif; ?>
  ...
  <div class="wrap">
    ...
    <div class="feat-grid">
      <div class="fc fc-wide reveal">
        ...
        <?php endif; ?>
        <a href="<?= url('profile') ?>?tab=plans" class="fc-arr" style="text-decoration:none"><i class="fas fa-arrow-up-right-from-square"></i></a>
      </div>
      <div class="fc reveal">
        ...
        <a href="<?= url('profile') ?>?tab=checkin" class="fc-arr" style="text-decoration:none"><i class="fas fa-arrow-up-right-from-square"></i></a>
      </div>
      <div class="fc reveal">
        ...
        <?php endif; ?>
        <a href="<?= url('profile') ?>?tab=classes" class="fc-arr" style="text-decoration:none"><i class="fas fa-arrow-up-right-from-square"></i></a>
      </div>
      <div class="fc reveal">
        ...
        <a href="<?= url('profile') ?>" class="fc-arr" style="text-decoration:none"><i class="fas fa-arrow-up-right-from-square"></i></a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="shop-grid" id="plansGrid">
    ...
    <div class="product-card <?= $is_hot ? 'plan-hot' : '' ?> reveal"
      ...
      <div class="product-footer" style="border-top-color:rgba(255,255,255,.08);<?= $is_hot ? 'border-top:2px solid '.htmlspecialchars($pt_color).'60' : '' ?>">
        ...
        <a href="<?= url('payment') ?>" class="product-add-btn" style="<?= $is_hot ? 'background:'.htmlspecialchars($pt_color).';color:#fff' : '' ?>">
  ...
  <div class="wrap">
    <div class="ctaf-inner reveal">
      <?php if ($is_customer): ?>
        ...
        <div class="ctaf-btns">
          <a href="<?= url('profile') ?>" class="btn-gold ctaf-btn"><i class="fas fa-user-circle"></i> Hồ sơ của tôi</a>
          <a href="<?= url('logout') ?>" class="btn-ghost-gold ctaf-btn">Đăng xuất <i class="fas fa-sign-out-alt"></i></a>
        </div>
      <?php else: ?>
        ...
        <div class="ctaf-btns">
          <a href="<?= url('login') ?>"       class="btn-gold ctaf-btn"><i class="fas fa-sign-in-alt"></i> Đăng nhập ngay</a>
          <a href="<?= url('register') ?>" class="btn-ghost-gold ctaf-btn">Tạo tài khoản miễn phí <i class="fas fa-arrow-right"></i></a>
        </div>
      <?php endif; ?>
    </div>
  </div>
    ...
    <div class="footer-grid">
      ...
      <div class="fg-col">
        ...
        <?php if ($is_customer): ?>
          ...
          <a href="<?= url('profile') ?>?tab=plans">Gói tập</a>
          <a href="<?= url('profile') ?>?tab=checkin">Check-in</a>
          <a href="<?= url('logout') ?>" style="color:#f87171">Đăng xuất</a>
        <?php else: ?>
