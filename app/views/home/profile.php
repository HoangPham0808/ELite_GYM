...
if (!$customer) { header("Location: " . url()); exit; }
    ...
    <div class="tab-panel <?= $active_tab==='info'?'active':'' ?>" id="tab-info">
      ...
      <div class="pcard">
        ...
        <div class="edit-form-section" id="editFormSection">
          <form method="POST" action="<?= url('api/profile') ?>" id="editInfoForm">
...
<div class="modal-overlay" id="modalOverlay">
  <div class="modal-box">
    ...
    <div id="pwStep1" style="display:<?= $pw_step===2 ? 'none':'block' ?>">
      ...
      <form method="POST" action="<?= url('api/profile') ?>" id="step1Form">
    ...
    <div id="pwStep2" style="display:<?= $pw_step===2 ? 'block':'none' ?>">
      ...
      <form method="POST" action="<?= url('api/profile') ?>" id="step2Form">
      ...
      <form method="POST" action="<?= url('api/profile') ?>" id="resendOtpForm" style="display:none">
